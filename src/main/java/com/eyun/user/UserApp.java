package com.eyun.user;

import com.eyun.user.client.OAuth2InterceptedFeignConfiguration;
import com.eyun.user.config.ApplicationProperties;
import com.eyun.user.config.DefaultProfileUtil;
